...
from quantx_api.agent_api import agent_router, run_trade_command_expiry_sweeper
...
async def lifespan(app: FastAPI):
  ...
  command_expiry_stopped = asyncio.Event()
  command_expiry_task = asyncio.create_task(
