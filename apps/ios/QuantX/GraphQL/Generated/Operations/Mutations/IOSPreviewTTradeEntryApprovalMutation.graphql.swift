...
extension QuantXAPI {
  nonisolated struct IOSPreviewTTradeEntryApprovalMutation: GraphQLMutation {
    static let operationName: String = "IOSPreviewTTradeEntryApproval"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation IOSPreviewTTradeEntryApproval($runId: String!, $intentId: String!) { previewTTradeEntryApproval(runId: $runId, intentId: $intentId) { __typename success code message preview { __typename challengeId confirmationToken action accountId executionOwner { __typename ownerType ownerId } intentId instrumentCode side bucket reason targetVolume referencePrice estimatedAmount signalExpiresAt challengeExpiresAt warnings } } }"#
      ))
    ...
    nonisolated struct Data: QuantXAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("previewTTradeEntryApproval", PreviewTTradeEntryApproval.self, arguments: [
          "runId": .variable("runId"),
          "intentId": .variable("intentId")
        ]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        IOSPreviewTTradeEntryApprovalMutation.Data.self
      ] }

      var previewTTradeEntryApproval: PreviewTTradeEntryApproval { __data["previewTTradeEntryApproval"] }

      /// PreviewTTradeEntryApproval
      nonisolated struct PreviewTTradeEntryApproval: QuantXAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          IOSPreviewTTradeEntryApprovalMutation.Data.PreviewTTradeEntryApproval.self
        ] }
        ...
        /// PreviewTTradeEntryApproval.Preview
        nonisolated struct Preview: QuantXAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            IOSPreviewTTradeEntryApprovalMutation.Data.PreviewTTradeEntryApproval.Preview.self
          ] }
          ...
          /// PreviewTTradeEntryApproval.Preview.ExecutionOwner
          nonisolated struct ExecutionOwner: QuantXAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              IOSPreviewTTradeEntryApprovalMutation.Data.PreviewTTradeEntryApproval.Preview.ExecutionOwner.self
            ] }
