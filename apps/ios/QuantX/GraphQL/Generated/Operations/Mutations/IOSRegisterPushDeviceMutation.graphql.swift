...
extension QuantXAPI {
  nonisolated struct IOSRegisterPushDeviceMutation: GraphQLMutation {
    static let operationName: String = "IOSRegisterPushDevice"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation IOSRegisterPushDevice($input: RegisterPushDeviceInput!) { registerPushDevice(input: $input) { __typename id deviceInstallId appBundleId appVersion environment registeredAt updatedAt preferences { __typename category enabled } } }"#
      ))
    ...
    nonisolated struct Data: QuantXAPI.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        IOSRegisterPushDeviceMutation.Data.self
      ] }

      var registerPushDevice: RegisterPushDevice { __data["registerPushDevice"] }

      /// RegisterPushDevice
      nonisolated struct RegisterPushDevice: QuantXAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          IOSRegisterPushDeviceMutation.Data.RegisterPushDevice.self
        ] }
        ...
        nonisolated struct Preference: QuantXAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            IOSRegisterPushDeviceMutation.Data.RegisterPushDevice.Preference.self
          ] }
