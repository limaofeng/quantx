...
export function useChartSync(
  ...
  mainSeriesRef:
    | React.RefObject<ISeriesApi<'Candlestick'> | ISeriesApi<'Line'> | null>
    | undefined,
  subSeriesMapRef: React.RefObject<
  ...
  useEffect(() => {
    ...
    const mainTimeHandler = (range: LogicalRange | null) =>
      syncTimeRange(mc, range);
    ...
    return () => {
      ...
      subscribedSubCharts.forEach(_subChart => {
