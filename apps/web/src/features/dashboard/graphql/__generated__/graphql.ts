...
/** 账户级两阶段执行控制动作 */
export enum AccountExecutionControlAction {
...
/** 确认账户级执行控制 */
export type AccountExecutionControlConfirmationInput = {
...
/** 卖出计划回放的历史持仓起点 */
export type ExitPlanReplayOriginInput = {
...
/** 卖出计划回放准备输入 */
export type ExitPlanReplayPreparationInput = {
  accountId: Scalars['String']['input'];
  draftTemplate?: InputMaybe<Scalars['JSON']['input']>;
  planId?: InputMaybe<Scalars['String']['input']>;
};

/** 启动卖出计划历史回放 */
export type ExitPlanReplayStartInput = {
  accountId: Scalars['String']['input'];
  commissionRate?: Scalars['Float']['input'];
  draftTemplate?: InputMaybe<Scalars['JSON']['input']>;
  endTime: Scalars['DateTime']['input'];
  expectedConfigVersion?: InputMaybe<Scalars['Int']['input']>;
  idempotencyKey: Scalars['String']['input'];
...
/** 卖出计划回放更新类型 */
export enum ExitPlanReplayUpdateKind {
  Created = 'CREATED',
  Progress = 'PROGRESS',
...
export type ManualOrderPreviewInput = {
  /** 必填资金账号 */
  accountId: Scalars['String']['input'];
  /** 默认 PAPER；LIVE 额外要求账户增仓授权、对账和唯一 Agent 就绪 */
...
export enum TTradeReplayPhase {
  ...
  Replaying = 'REPLAYING',
  ValidatingPortfolio = 'VALIDATING_PORTFOLIO',
  VerifyingData = 'VERIFYING_DATA'
}

/** 做 T 历史回放的不可变初始组合 */
export type TTradeReplayPortfolioInput = {
  asOf: Scalars['DateTime']['input'];
  cashAvailable?: InputMaybe<Scalars['Float']['input']>;
  positions: Array<TTradeReplayPositionInput>;
  snapshotId?: InputMaybe<Scalars['String']['input']>;
  source: TTradeReplayPortfolioSource;
};

/** 做 T 历史回放初始组合来源 */
export enum TTradeReplayPortfolioSource {
  Manual = 'MANUAL',
  Snapshot = 'SNAPSHOT'
}
...
export type Dashboard_MarketIndexSnapshotsQueryVariables = Exact<{
  stockList: Array<Scalars['String']['input']> | Scalars['String']['input'];
}>;


export type Dashboard_MarketIndexSnapshotsQuery = { __typename?: 'Query', marketIndexSnapshots: Array<{ __typename?: 'MarketIndexSnapshot', stockCode: string, quote?: { __typename?: 'StockQuote', stockCode: string, time: string, lastPrice: number, open: number, high: number, low: number, preClose: number, volume: number } | null, dailyKline?: { __typename?: 'KLineData', stockCode: string, time: string, open: number, high: number, low: number, close: number, preClose: number, volume: number } | null }> };
...
export const Dashboard_MarketIndexSnapshotsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Dashboard_MarketIndexSnapshots"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"stockList"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"marketIndexSnapshots"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"stockList"},"value":{"kind":"Variable","name":{"kind":"Name","value":"stockList"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stockCode"}},{"kind":"Field","name":{"kind":"Name","value":"quote"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stockCode"}},{"kind":"Field","name":{"kind":"Name","value":"time"}},{"kind":"Field","name":{"kind":"Name","value":"lastPrice"}},{"kind":"Field","name":{"kind":"Name","value":"open"}},{"kind":"Field","name":{"kind":"Name","value":"high"}},{"kind":"Field","name":{"kind":"Name","value":"low"}},{"kind":"Field","name":{"kind":"Name","value":"preClose"}},{"kind":"Field","name":{"kind":"Name","value":"volume"}}]}},{"kind":"Field","name":{"kind":"Name","value":"dailyKline"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stockCode"}},{"kind":"Field","name":{"kind":"Name","value":"time"}},{"kind":"Field","name":{"kind":"Name","value":"open"}},{"kind":"Field","name":{"kind":"Name","value":"high"}},{"kind":"Field","name":{"kind":"Name","value":"low"}},{"kind":"Field","name":{"kind":"Name","value":"close"}},{"kind":"Field","name":{"kind":"Name","value":"preClose"}},{"kind":"Field","name":{"kind":"Name","value":"volume"}}]}}]}}]}}]} as unknown as DocumentNode<Dashboard_MarketIndexSnapshotsQuery, Dashboard_MarketIndexSnapshotsQueryVariables>;