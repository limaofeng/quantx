  ...
  return (
    <div className="rounded-panel border border-slate-200 bg-slate-50 p-ui-section dark:border-white/10 dark:bg-white/[0.03]">
      <div className="mb-4 flex items-center justify-between">
        <div className={`rounded-panel p-2.5 ${tone}`}>
          <Icon className="h-4 w-4" />
        </div>
        <span className="text-ui-micro font-black uppercase tracking-[0.2em] text-slate-400">
          Bucket
        </span>
      </div>
      <div className="text-ui-caption font-black uppercase tracking-[0.24em] text-slate-500">
        {label}
      </div>
      <div className="mt-2 font-mono text-ui-display font-black text-slate-900 dark:text-white">
        {value}
      </div>
    </div>
  );
    ...
    <div className="space-y-ui-section">
      <Card className="rounded-panel border border-slate-200 bg-white p-ui-panel shadow-none dark:border-white/10 dark:bg-slate-900/60">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <p className="max-w-lg text-ui-label font-medium leading-relaxed text-slate-500">
      ...
      <div className="grid grid-cols-1 gap-ui-section md:grid-cols-3">
        <BucketTile
          label="封存仓"
      ...
      <Card className="rounded-panel border border-slate-200 bg-white p-ui-section shadow-none dark:border-white/10 dark:bg-slate-900/60">
        <div className="flex items-center justify-between">
          <span className="text-ui-micro font-black uppercase tracking-[0.24em] text-slate-400">
            更新时间
          </span>
          <span className="font-mono text-ui-label font-bold text-slate-600 dark:text-slate-300">
            {ledger.updatedAt
