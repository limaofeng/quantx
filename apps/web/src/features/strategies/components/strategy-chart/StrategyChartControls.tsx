...
export function StrategyChartControls({
  ...
  return (
    <div className="absolute top-4 left-4 z-20 flex items-center gap-2">
      <div className="h-9 p-1 rounded-panel bg-slate-950/85 backdrop-blur-md border border-white/10 flex items-center shadow-lg shadow-black/20">
        <DropdownMenu>
          ...
          >
            <div className="px-2 py-1.5 text-ui-caption uppercase font-bold text-slate-500">
              常用周期
            </div>
            ...
            <div className="px-2 py-1.5 text-ui-caption uppercase font-bold text-slate-500 mt-2 border-t border-white/10 pt-2">
              分钟周期
            </div>
