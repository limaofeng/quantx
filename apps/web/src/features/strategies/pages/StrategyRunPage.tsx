                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-start">
                  ...
                  <div className="lg:col-span-4 space-y-4">
                        ...
                        {[
                          {
                            ...
                            label: '回测',
                            icon: LineChart,
                            activeClass: 'border-red-400 bg-red-500 shadow-xl',
                          },
                          {
                            ...
                            icon: TestTube,
                            activeClass:
                              'border-emerald-400 bg-emerald-500 shadow-xl',
                          },
                          {
                            mode: StrategyRunMode.Live,
                            label: '实盘',
                            icon: Rocket,
                            activeClass:
                              'border-rose-400 bg-rose-500 shadow-xl',
                          },
                    ...
                    {runMode === StrategyRunMode.Live && (
                      <div className="rounded-xl border border-rose-500/20 bg-rose-500/10 px-3 py-2 text-[10px] leading-relaxed text-rose-200">
