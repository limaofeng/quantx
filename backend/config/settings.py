...
class Settings(BaseSettings):
  ...
  cors_origins: Union[List[str], str] = Field(
    default=["http://localhost:5250", "http://localhost:3000", "http://localhost:5173"],
  ...
  prefect_api_url: str = Field(
    default="http://127.0.0.1:4200/api", description="外部Prefect服务器URL"
  )
  prefect_worker_pool: str = Field(
    default="my-docker-pool", description="Prefect Worker连接的工作池名称"
  )
