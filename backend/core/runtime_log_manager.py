...
from gqlapi.types.strategy_subscription_types import LogLevel, StrategyLogEntry
...
class RuntimeLogManager:
    ...
    def __init__(self, history_max: int = 50) -> None:
        ...
        self._history: Dict[str, Deque[StrategyLogEntry]] = {}
    ...
    def append(
        ...
        *,
        ...
        log_entry = StrategyLogEntry.create(
            run_id=run_id,
            level=log_level,
            message=message,
            source=source,
    ...
    def _append_file_record(self, log_entry: StrategyLogEntry) -> None:
    ...
    def get_recent(self, run_id: str, limit: Optional[int] = None) -> List[StrategyLogEntry]:
        """获取最近日志"""
