...
class RuntimeStateManager:
    ...
    def __post_init__(self):
        from core.trading.bucket_ledger import BucketLedger
        from core.trading.decision_trace import DecisionTraceLogger
    ...
    def update_position(
        ...
        **position_data,
        ...
        """更新持仓（同步）"""
        from core.trading.portfolio_state import ensure_position_dict
    ...
    def settle_trading_day(self, trading_date: date) -> None:
        ...
        from core.trading.portfolio_state import settle_position
    ...
    async def _persist_decision_trace_record(self, trace) -> None:
        try:
            from database.connection import get_async_db
            from repositories.strategy_decision_trace_repository import (
