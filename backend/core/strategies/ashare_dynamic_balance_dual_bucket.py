...
from core.trading.bucket_ledger import CORE_BUCKET, LOCKED_CORE_BUCKET, SWING_BUCKET
from models.enums import StrategyCategory, StrategyInstrumentScope
  ...
  def get_parameter_schema(cls) -> ParameterSchema:
    return ParameterSchema(
      ...
      properties={
        ...
        "cash_buffer_pct": ParameterProperty(type="number", minimum=0.0, maximum=0.8, default=0.20, group="risk"),
        ...
        "rebalance_threshold_pct": ParameterProperty(type="number", minimum=0.002, maximum=0.10, default=0.02, group="balance"),
        ...
        "min_expected_profit_bps": ParameterProperty(type="number", minimum=0.0, maximum=200.0, default=20.0, group="risk"),
        "high_distribution_volume_ratio": ParameterProperty(type="number", minimum=1.0, maximum=5.0, default=1.6, group="state"),
        "downtrend_grid_buy_block": ParameterProperty(type="boolean", default=True, group="state"),
