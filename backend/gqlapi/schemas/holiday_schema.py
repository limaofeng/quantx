...
from gqlapi.types.holiday_types import Holiday, HolidayQueryResult, HolidayMutationResult, HolidayInput
from gqlapi.resolvers.holidays import HolidayResolver
