...
from models.closed_position_cycle import ClosedPositionCycle
from models.enums import OrderType
from models.position import Position
from models.trade import Trade
from repositories.closed_position_cycle_repository import (
...
class ClosedPositionCycleService:
  ...
  async def record_position_closed(
    ...
    *,
    ...
    opened_at = position.created_at or closed_at
  ...
  async def _rebuild(
    ...
    start_at = (cycle.opened_at or cycle.closed_at) - self.TRADE_CALLBACK_LOOKBACK
    result = await db.execute(
      ...
      .where(
        ...
        Trade.time >= start_at,
        Trade.time <= cycle.closed_at + self.TRADE_CALLBACK_LOOKBACK,
      )
