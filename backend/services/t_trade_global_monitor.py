"""Account-level orchestration for the dynamic-holdings T strategy."""
...
from models.t_trade_global_config import TTradeGlobalConfig
from repositories.instrument_repository import InstrumentRepository
from repositories.t_trade_global_config_repository import TTradeGlobalConfigRepository
...
class TTradeGlobalMonitorService:
  ...
  def __init__(self, interval_seconds: float = 10.0):
    ...
    self.session_service = TTradeService()
  ...
  async def _reconcile_account_locked(self, account_id: str) -> Dict[str, Any]:
    ...
    errors: List[str] = []
    try:
      await self.position_service.refresh_from_miniqmt(account_id)
