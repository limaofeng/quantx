...
from services.announcement_provider import AnnouncementRecord, RepurchaseRecord
from services.announcement_sync_service import AnnouncementSyncService


@pytest.mark.asyncio
async def test_refresh_uses_akshare_by_default_without_feature_flag(monkeypatch):
  import services.announcement_sync_service as module
