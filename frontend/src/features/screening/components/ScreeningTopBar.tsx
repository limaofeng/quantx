import { Search, RefreshCw, X, Check, Target } from 'lucide-react';
...
interface ScreeningTopBarProps {
  ...
  setScreeningCriteria: (
    criteria:
      | ScreeningCriteria
      | ((prev: ScreeningCriteria) => ScreeningCriteria)
  ) => void;
    ...
    <div className="flex flex-col gap-4 p-4 shrink-0 bg-[#0F1729]/80 backdrop-blur-md border-b border-white/5 z-20 shadow-xl">
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden xl:grid grid-cols-2 gap-x-4 gap-y-1 border-r border-white/5 pr-4 text-right">
            <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">
              信号日期
            </span>
