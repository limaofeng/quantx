  ...
  return (
    <div className="space-y-5">
      ...
      {traces.map(trace => (
        <Card
          key={trace.id}
          className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-xl dark:border-white/10 dark:bg-slate-900/60"
        >
          <div className="mb-5 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              <div className="rounded-lg bg-blue-500/10 px-2.5 py-1 text-[9px] font-black uppercase tracking-widest text-blue-500">
                策略意图
              </div>
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
            ...
            <Stage label="OrderSizer" value={trace.sizingResult} tone="blue" />
