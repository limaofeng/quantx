"""Command-line entry point for the read-only P1 cutover rehearsal."""
...
def main(argv: list[str] | None = None) -> int:
  ...
  from quantx_infrastructure.services.t_assistant_p1_cutover_rehearsal import (
    main as rehearsal_main,
  )

  return rehearsal_main(argv)
