  ...
  def build_snapshot(
    ...
    *,
    ...
    limit_up = _optional_float(
      ...
      or _get(market_data, "up_stop_price")
      or _get(instrument, "limit_up")
      or _get(instrument, "up_stop_price")
    )
    limit_down = _optional_float(
      _get(market_data, "limit_down")
      or _get(market_data, "down_stop_price")
      or _get(instrument, "limit_down")
      or _get(instrument, "down_stop_price")
    )
