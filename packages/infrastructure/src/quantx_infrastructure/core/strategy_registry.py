...
from quantx_domain.strategies.base import StrategyBase
...
class StrategyMetadata:
  ...
  def module_path(self) -> str:
    ...
    例如: "quantx_domain/strategies/rsi_strategy.py"
          -> "quantx_infrastructure.core.strategies.rsi_strategy"
...
class StrategyRegistry:
  ...
  def discover_strategies(
    self, package_name: str = "quantx_domain.strategies"
  ...
  def _extract_metadata(
    ...
    try:
      ...
      return StrategyMetadata(
        ...
        file_path=f"quantx_domain/strategies/{module_name}.py",
  ...
  def get_strategy_class(
    ...
    try:
      ...
      if metadata:
        ...
        # 例如: "quantx_domain/strategies/ma_cross.py" -> "quantx_infrastructure.core.strategies.ma_cross"
