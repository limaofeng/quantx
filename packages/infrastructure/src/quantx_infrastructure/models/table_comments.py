...
TABLE_COMMENTS: dict[str, str] = {
  "history_download_settings": "全局历史补采允许时段配置",
  "development_data_export": "跨环境只读历史行情导出任务与开发导入凭证",
  ...
  "account_risk_increase_admission_items": "风险增加准入批次内的确定性意图排名",
  ...
  "stock_selection_model_versions": "次日上涨概率模型证据与人工发布阶段",
  ...
  "stock_prediction_runs": "次日上涨概率日推理原子运行",
  "stock_predictions": "次日上涨概率全市场只读预测",
  "stock_candidate_rule_versions": "概率候选资格与分级规则版本",
  "stock_candidates": "次日上涨概率只读研究候选",
  "strategies": "策略模板",
