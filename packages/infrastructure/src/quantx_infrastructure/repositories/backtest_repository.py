...
class BacktestRepository:
  ...
  async def create_backtest(
    ...
    *,
    ...
    backtest = StrategyBacktest(
      ...
      backtest_start_time=backtest_start_time.replace(tzinfo=None)
      if backtest_start_time
      else None,
      backtest_end_time=backtest_end_time.replace(tzinfo=None)
      if backtest_end_time
      else None,
      status="PENDING",
  ...
  async def get_backtests_by_run(self, strategy_run_id: str) -> List[StrategyBacktest]:
