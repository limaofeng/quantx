  ...
  async def start(
    ...
    *,
    ...
    parameters = {
      **settings,
      "t_trade_replay": True,
      # All historical replay runs have the same durable boundary: one
      # coordinator-owned checkpoint per virtual trading day.  This is not a
      # pressure-run capability and cannot be changed by request settings.
      RUNTIME_STATE_CHECKPOINT_POLICY_KEY: RUNTIME_STATE_CHECKPOINT_POLICY_DAY_BATCH,
