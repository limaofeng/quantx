...
class TestPortfolioSummaryGraphQL:
  ...
  @pytest.mark.asyncio
  @pytest.mark.api
  async def test_portfolio_summary_query_basic(self, authorized_graphql_context):
    """测试基础的持仓汇总查询"""
    query = """
    query {
      portfolioSummary {
    ...
    result = await schema.execute(
      query, context_value=authorized_graphql_context
    )
  ...
  @pytest.mark.asyncio
  @pytest.mark.api
  async def test_portfolio_summary_query_with_top_holdings(
    self, authorized_graphql_context
  ):
    """测试包含重要持仓的汇总查询"""
    query = """
    query {
  ...
  @pytest.mark.asyncio
  @pytest.mark.api
  async def test_portfolio_summary_query_with_account_id(
    self, authorized_graphql_context
  ):
    """测试指定账户ID的汇总查询"""
    query = """
  ...
  @pytest.mark.asyncio
  @pytest.mark.api
  async def test_portfolio_summary_query_selective_fields(
    self, authorized_graphql_context
  ):
    """测试 GraphQL 按需字段选择"""
    # 只查询部分字段
  ...
  @pytest.mark.asyncio
  @pytest.mark.api
  async def test_portfolio_summary_query_top_holdings_selective(
    self, authorized_graphql_context
  ):
    """测试重要持仓的按需字段选择"""
    query = """
  ...
  @pytest.mark.asyncio
  @pytest.mark.api
  async def test_portfolio_summary_query_error_handling(
    self, authorized_graphql_context
  ):
    """测试错误处理"""
    # 使用无效的账户ID
  ...
  @pytest.mark.asyncio
  @pytest.mark.api
  async def test_portfolio_summary_performance(
    self, authorized_graphql_context
  ):
    """测试查询性能"""
    import time
