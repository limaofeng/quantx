...
This test intentionally uses the project database configured by apps/api/.env
and apps/api/.env.testing. It does not create a temporary SQLite database and does
