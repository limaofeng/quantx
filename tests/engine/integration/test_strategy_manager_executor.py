...
class TestStrategyManagerExecutorIntegration:
  ...
  def mock_external_deps(self):
    ...
    with (
      patch('quantx_engine.strategy_executor.adapter_manager.get_adapter_for_mode') as mock_adapter,
      patch('quantx_engine.strategy_executor.BacktestBroker') as mock_broker,
      patch('quantx_engine.strategy_executor.adapter_manager.release_adapter_for_mode') as mock_release,
