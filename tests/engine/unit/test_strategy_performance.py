...
from quantx_infrastructure.core.strategy_performance import StrategyPerformanceService
...
def test_build_performance_calculates_core_risk_and_trade_stats():
  performance = StrategyPerformanceService.build_performance(
    ...
    metrics={
      ...
      "constraint_statistics": {
        "limit_up_buy_blocked": 4,
        "book_depth_capped_orders": 2,
        "expired_orders": 1,
        "unfilled_volume": 300,
      },
    },
  ...
  assert performance["execution_quality"]["limit_up_buy_blocked"] == 4
  assert performance["execution_quality"]["book_depth_capped_orders"] == 2
  assert performance["execution_quality"]["expired_orders"] == 1
  assert performance["execution_quality"]["unfilled_volume"] == 300
