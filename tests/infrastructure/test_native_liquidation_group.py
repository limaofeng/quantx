  ...
  async with native_liquidation_database() as db:
    ...
    db.add(
      AutoExitPlanRecord(
        ...
        source_execution_owner_id="new-conflict-after-confirm",
        source_execution_environment=other_plan_mode.upper(),
        enabled=True,
        status="ACTIVE",
        environment=other_plan_mode.upper(),
    ...
    db.add_all(
      [
        ...
        PendingTradeOrder(
          ...
          owner_id="pending-sell",
          environment=order_mode.upper(),
          bucket="manual",
          request_metadata={},
        ),
      ]
