    ...
    db.add_all(
      [
        ...
        TTradeBatch(
          ...
          source_execution_owner_id="strategy-run-1",
        ...
        PendingTradeOrder(
          ...
          status="QUEUED",
          strategy_run_id="strategy-run-1",
          strategy_order_id="t-strategy-order-1",
          intent_id="t-intent-1",
          batch_id="t-batch-1",
          bucket="swing",
          t_trade_role="ENTRY",
          trace_id="t-trace-1",
        ...
        TradeCommandOutbox(
          ...
          payload={
            ...
            "limit_price": "10.00",
            "volume": 100,
            "expires_at": (utcnow() + timedelta(minutes=5)).isoformat() + "Z",
          },
          delivery_status="QUEUED",
          expires_at=utcnow(),
          attempts=0,
