...
def test_websocket_close_reason_prefers_received_stable_reason() -> None:
  received = type(
    "CloseFrame",
    (),
    {"reason": "QMT_CONTROL_SESSION_REPLACED"},
  )()
  sent = type("CloseFrame", (), {"reason": "local-fallback"})()
  exc = type(
    "ClosedConnection",
    (Exception,),
    {"rcvd": received, "sent": sent},
  ...
  assert (
    runtime_module._websocket_close_reason(exc)
