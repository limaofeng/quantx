...
def test_status_cli_reports_drain_without_claiming_execution_exit(tmp_path, monkeypatch, capsys):
  ...
  assert value == {"service": "OFFLINE", "execution_state": "NOT_INSPECTED", "admission": "OPEN", "host_resources": {"status": "PASS", "reason": None}, "backend": {"state": "UNKNOWN"}, "activity": {"state": "UNKNOWN"}}
